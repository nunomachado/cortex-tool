		...
		if(sym_v == null) { // the condition is concrete
			...
			if (conditionValue) {
				...
				if(!pc.simplify())  {// not satisfiable
					ss.setIgnored(true);
					System.out.println("[IFNULL] not satisfiable target");
				}else{
					//pc.solve();
					((PCChoiceGenerator) cg).setCurrentPC(pc);
					//System.out.println(((PCChoiceGenerator) cg).getCurrentPC());
					System.out.println("[IFNULL] get target");
				}
				...
				if(!pc.simplify())  {// not satisfiable
					ss.setIgnored(true);
					System.out.println("[IFNULL] not satisfiable next");
				}else{
					//pc.solve();
					((PCChoiceGenerator) cg).setCurrentPC(pc);
					//System.out.println(((PCChoiceGenerator) cg).getCurrentPC());
					System.out.println("[IFNULL] get next");
				}
				return getNext(ti);
			}
		}
