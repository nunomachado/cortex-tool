...
public class IF_ICMPLT extends gov.nasa.jpf.jvm.bytecode.IF_ICMPLT{
	...
	public Instruction execute (SystemState ss, KernelState ks, ThreadInfo ti) {
		...
		if ((sym_v1 == null) && (sym_v2 == null)) { // both conditions are concrete
			...
			//System.out.println("Concrete IF_ICMPLT on thread: "+ti.getId()+" "+ti.getThreadObjectClassInfo().getName()+" "+ti.getLine());
			return super.execute(ss, ks, ti);
		}else{ // at least one condition is symbolic
			ChoiceGenerator<?> cg;
			//System.out.println("Symbolic IF_ICMPLT on thread: "+ti.getId()+" "+ti.getThreadObjectClassInfo().getName()+" "+ti.getLine());
