...
/**
 * JPF test driver for java.util.concurrent.atomic.AtomicLongArray
 *
 * @author Mateusz Ujma <mateusz.ujma@gmail.com>
 */
public class AtomicLongArrayTest extends TestCaseHelpers {
  ...
  public void testCountingInMultipleThreads() {
    if (verifyNoPropertyViolation(JPF_ARGS)) {
      try {
        final AtomicLongArray ai = new AtomicLongArray(SIZE/2);
