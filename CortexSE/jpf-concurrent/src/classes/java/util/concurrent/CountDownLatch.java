...
public class CountDownLatch {
  ...
  private int version = 0;
    ...
    public CountDownLatch(int count) {
        ...
        newCountDownLatch(count);
    }

    public native void await() throws InterruptedException;

    public native boolean await(long timeout, TimeUnit unit) throws InterruptedException;
    ...
    private native void newCountDownLatch(int count);
